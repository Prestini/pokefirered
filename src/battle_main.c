...
const u8 gTypeEffectiveness[444] =
{
    ...
    TYPE_GOD, TYPE_NORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_POISON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_GROUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_MYSTERY, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_FIRE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_GRASS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_ELECTRIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GOD, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_NORMAL, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_FIGHTING, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_FLYING, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_POISON, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_GROUND, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_ROCK, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_BUG, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_STEEL, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_MYSTERY, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_FIRE, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_WATER, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_GRASS, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_ELECTRIC, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_PSYCHIC, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_ICE, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_DRAGON, TYPE_GOD, TYPE_MUL_NO_EFFECT,
    TYPE_DARK, TYPE_GOD, TYPE_MUL_NO_EFFECT,
